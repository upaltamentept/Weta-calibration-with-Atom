...
"""autogenerated by genpy from atom_msgs/PointCloudWithLidar3DLabels.msg. Do not edit."""
import codecs
import sys
...
class PointCloudWithLidar3DLabels(genpy.Message):
  _md5sum = "8718797d8c5c69f369339615842a11b1"
  _type = "atom_msgs/PointCloudWithLidar3DLabels"
...
"""
  __slots__ = ['header','point_cloud','patterns']
  _slot_types = ['std_msgs/Header','sensor_msgs/PointCloud2','atom_msgs/Lidar3DLabels[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PointCloudWithLidar3DLabels, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.patterns:
        _x = val1.pattern_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
        ...
        _x = val1.detected
        buff.write(_get_struct_B().pack(_x))
        length = len(val1.idxs)
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.Struct(pattern).pack(*val1.idxs))
        length = len(val1.idxs_limit_points)
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.Struct(pattern).pack(*val1.idxs_limit_points))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.patterns = []
      for i in range(0, length):
        val1 = atom_msgs.msg.Lidar3DLabels()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.pattern_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.pattern_name = str[start:end]
        start = end
        end += 1
        (val1.detected,) = _get_struct_B().unpack(str[start:end])
        ...
        val1.idxs = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sI'%length
        ...
        val1.idxs_limit_points = s.unpack(str[start:end])
        self.patterns.append(val1)
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.patterns:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(val1.idxs.tostring())
        length = len(val1.idxs_limit_points)
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(val1.idxs_limit_points.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.idxs = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sI'%length
        ...
        val1.idxs_limit_points = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
        self.patterns.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
