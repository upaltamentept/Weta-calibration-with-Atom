...
(cl:defclass <DepthLabels> (roslisp-msg-protocol:ros-message)
  ((pattern_name
    :reader pattern_name
...
(cl:defclass DepthLabels (<DepthLabels>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <DepthLabels>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'DepthLabels)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atom_msgs-msg:<DepthLabels> is deprecated: use atom_msgs-msg:DepthLabels instead.")))

(cl:ensure-generic-function 'pattern_name-val :lambda-list '(m))
(cl:defmethod pattern_name-val ((m <DepthLabels>))
...
(cl:defmethod detected-val ((m <DepthLabels>))
...
(cl:defmethod idxs-val ((m <DepthLabels>))
...
(cl:defmethod idxs_limit_points-val ((m <DepthLabels>))
  ...
  (idxs_limit_points m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DepthLabels>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DepthLabels>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DepthLabels>)))
  "Returns string type for a message object of type '<DepthLabels>"
  "atom_msgs/DepthLabels")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DepthLabels)))
  "Returns string type for a message object of type 'DepthLabels"
  "atom_msgs/DepthLabels")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DepthLabels>)))
  "Returns md5sum for a message object of type '<DepthLabels>"
  "1feeee9a8d44fc8fa147e3f3e0194a1e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DepthLabels)))
  "Returns md5sum for a message object of type 'DepthLabels"
  "1feeee9a8d44fc8fa147e3f3e0194a1e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DepthLabels>)))
  "Returns full string definition for message of type '<DepthLabels>"
  (cl:format cl:nil "string pattern_name~%bool detected~%uint32[] idxs~%uint32[] idxs_limit_points~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DepthLabels)))
  "Returns full string definition for message of type 'DepthLabels"
  (cl:format cl:nil "string pattern_name~%bool detected~%uint32[] idxs~%uint32[] idxs_limit_points~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <DepthLabels>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DepthLabels>))
