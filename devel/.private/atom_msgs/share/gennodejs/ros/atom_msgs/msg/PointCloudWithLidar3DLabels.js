...
class PointCloudWithLidar3DLabels {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.patterns.forEach((val) => {
      bufferOffset = Lidar3DLabels.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PointCloudWithLidar3DLabels(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.patterns[i] = Lidar3DLabels.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.patterns.forEach((val) => {
      length += Lidar3DLabels.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PointCloudWithLidar3DLabels(null);
    ...
    if (msg.patterns !== undefined) {
      ...
      for (let i = 0; i < resolved.patterns.length; ++i) {
        resolved.patterns[i] = Lidar3DLabels.Resolve(msg.patterns[i]);
      }
    }
    else {
      resolved.patterns = []
...
module.exports = PointCloudWithLidar3DLabels;
