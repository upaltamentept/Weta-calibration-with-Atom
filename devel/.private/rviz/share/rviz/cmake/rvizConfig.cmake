...
if("TRUE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/pedro/ros/workspaces/atom/src/rviz)
  set(rviz_DEVEL_PREFIX /home/pedro/ros/workspaces/atom/devel/.private/rviz)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/pedro/ros/workspaces/atom/install)
...
if(NOT "/home/pedro/ros/workspaces/atom/devel/.private/rviz/include;/home/pedro/ros/workspaces/atom/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include " STREQUAL " ")
  set(rviz_INCLUDE_DIRS "")
  set(_include_dirs "/home/pedro/ros/workspaces/atom/devel/.private/rviz/include;/home/pedro/ros/workspaces/atom/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include")
  ...
  elseif(NOT "http://wiki.ros.org/rviz " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Robert Haschke <rhaschke@techfak.uni-bielefeld.de>, Chris Lalancette <clalancette@openrobotics.org>, Alejandro Hernandez Cordero <alejandro@openrobotics.org>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pedro/ros/workspaces/atom/src/rviz/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pedro/ros/workspaces/atom/devel/.private/rviz/lib;/home/pedro/ros/workspaces/atom/devel/lib;/opt/ros/noetic/lib)
